...
class bcc_iron( Mineral ):
    """
    BCC iron from Saxena and Eriksson (2015)
    """
    def __init__(self):
        formula={'Fe': 1.0}
...
class fcc_iron( Mineral ):
    """
    FCC iron from Saxena and Eriksson (2015)
    """
    def __init__(self):
        formula={'Fe': 1.0}
        m = formula_mass(formula)
...
class hcp_iron( Mineral ):
    """
    HCP iron from Saxena and Eriksson (2015)
    """
    def __init__(self):
        formula={'Fe': 1.0}
        m = formula_mass(formula)
...
class liquid_iron( Mineral ):
    """
    Liquid iron from Saxena and Eriksson (2015)
    """
    def __init__(self):
        formula={'Fe': 1.}
        m = formula_mass(formula)
