...
"""
liq_fcc_experiments = [{'id': 'ozawa_3', 'P': 47.e9, 'T': 3160, 'P_unc': 4e9, 'T_unc': 170,
...
liq_bcc_experiments = [{'id': 'ozawa_16', 'P': 115e9, 'T': 4060, 'P_unc': 4e9, 'T_unc': 0,
...
eutectic_experiments = [{'id': 'fischeut_1', 'P': 50e9, 'T': 2750, 'P_unc': 0e9, 'T_unc': 50,
...
FeSi_experiments = [{'id': 'fischer2013_59', 'P': 80.3e9, 'T': 3615, 'P_unc': 1.6e9, 'T_unc': 121,
...
experiments = copy.deepcopy(liq_fcc_experiments)
experiments.extend(liq_bcc_experiments)
experiments.extend(eutectic_experiments)
experiments.extend(FeSi_experiments)
